...
public:
    ...
    static void drawRect(Mat &mat, const Vec2I32 &pos, const int32_t &width, const int32_t &height, const Vec3U8 &color);
    static void drawRect(Mat &mat, const Vec2I32 &p1, const Vec2I32 &p2, const Vec2I32 &p3, const Vec2I32 &p4, const Vec3U8 &color);
    static void drawPoly(Mat &mat, std::vector<Vec2I32> &points, const Vec3U8 &color);
