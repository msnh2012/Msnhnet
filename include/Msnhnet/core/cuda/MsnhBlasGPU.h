...
public:
    ...
    static void gpuSimpleCopy(const int &n,  float * const &src, float * const &dst);
    ...
    static void gpuScientific(const Scientific &type, const int &n, float *const &x, const int &stepX,
    ...
    static void gpuFastSum(const int &axis, const int &batch, const int &channel, const int &width, const int &height, float *const &input, float *output, const ReductionType &reductionType);
    ...
    static void gpuBilinearResize(float *const &in, const int &width, const int &height, const int &channel, const int &batch, const int &outWidth,
