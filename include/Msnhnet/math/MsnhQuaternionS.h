...
public:
    ...
    {
        if(abs(q0-q.q0)<MSNH_F64_EPS&&
                abs(q1-q.q1)<MSNH_F64_EPS&&
                abs(q2-q.q2)<MSNH_F64_EPS&&
                abs(q3-q.q3)<MSNH_F64_EPS)
        {
            return true;
        }
        else
...
public:
    ...
    {
        if(abs(q0-q.q0)<MSNH_F32_EPS&&
                abs(q1-q.q1)<MSNH_F32_EPS&&
                abs(q2-q.q2)<MSNH_F32_EPS&&
                abs(q3-q.q3)<MSNH_F32_EPS)
        {
            return true;
        }
        else
