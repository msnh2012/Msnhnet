...
public:
    ...
    static std::vector<float> getImgDataF32C3(const std::string &path,  const Vec2I32 &size, const bool &needShuffleRGB=true);
    static std::vector<float> getImgDataF32C3(Mat &mat,  const Vec2I32 &size, const bool &needShuffleRGB=true);
    ...
    static std::vector<float> getPaddingZeroF32C3(const std::string &path,  const Vec2I32 &size, const bool &needShuffleRGB=false);
    static std::vector<float> getPaddingZeroF32C3(Mat &mat,  const Vec2I32 &size, const bool &needShuffleRGB=false);
    ...
    static void drawYoloBox(Mat &mat, std::vector<string> &labels, std::vector<std::vector<Msnhnet::YoloBox>> &boxs, const Point2I &size, const bool &noPad = false);
