...
#ifdef USE_OPENCV
void yolov5mOpencv(const std::string& msnhnetPath, const std::string& msnhbinPath, const std::string& imgPath,  const std::string& labelsPath)
{
    try
    {
...
void yolov5mMsnhCV(const std::string& msnhnetPath, const std::string& msnhbinPath, const std::string& imgPath,  const std::string& labelsPath)
{
    try
    {
        Msnhnet::NetBuilder  msnhNet;
...
#ifdef USE_OPENCV
    yolov5mOpencv(msnhnetPath, msnhbinPath, imgPath,labelsPath);
#else
    yolov5mMsnhCV(msnhnetPath, msnhbinPath, imgPath, labelsPath);
#endif
    getchar();
